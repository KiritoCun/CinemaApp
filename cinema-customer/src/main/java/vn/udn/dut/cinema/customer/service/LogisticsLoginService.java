...
@Slf4j
@Service
public class LogisticsLoginService {
    ...
    private SysUserVo loadUserByUsername(String tenantId, String username) {
        SysUser user = userMapper.selectOne(new LambdaQueryWrapper<SysUser>()
            ...
            .eq(SysUser::getUserName, username).eq(SysUser::getSystemType, SystemConstants.SYSTEM_TYPE_LOGISTICS));
        ...
        return userMapper.selectUserLogisticsByUserName(username);
    }
