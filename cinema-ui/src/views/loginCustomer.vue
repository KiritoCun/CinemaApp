    ...
    <div :class="{ hasTagsView: true, sidebarHide: true }" class="main-container">
      <div class="login-body" @scroll="onScroll" id="loginBody">
        ...
        <div class="document-container" id="promotion">
          ...
          <div class="document-items">
            <Carousel v-bind="{itemsToShow: 4, snapAlign: 'center'}">
              <Slide v-for="guideline in guidelineList" :key="guideline.id">
                <div class="document-item">
                  <img class="document-image2" :src="guideline.src" />
                  ...
                  <div class="document-date">
                    ...
                    <span>{{ parseTime(guideline.createTime, '{d}/{m}/{y}') }}</span>
                  </div>
                </div>
              </Slide>
              <template #addons>
...
const guidelineList = ref<any[]>(
  [{ docUrl: 'Hoa', docTitle: 'Ngày hội khuyến mãi ưu đãi thành viên', docDescription: 'Diễn ra duy nhất ngày 11/11', createTime: '01/11/2023', src: 'https://ocwckgy6c1obj.vcdn.cloud/media/banner/cache/1/b58515f018eb873dafa430b6f9ae0c1e/2/4/240x201-uu.jpg'},
  { docUrl: 'Hoa', docTitle: 'Ngày thứ tư vui vẻ', docDescription: 'Diễn ra hàng tuần', createTime: '01/11/2023', src: 'https://ocwckgy6c1obj.vcdn.cloud/media/banner/cache/1/b58515f018eb873dafa430b6f9ae0c1e/2/0/2023_happy_wed_75k_000_240x201.png'},
  { docUrl: 'Hoa', docTitle: 'Sinh nhật Star Cinema', docDescription: 'Diễn ra hàng năm vào ngày 09/11', createTime: '01/11/2023', src: 'https://ocwckgy6c1obj.vcdn.cloud/media/banner/cache/1/b58515f018eb873dafa430b6f9ae0c1e/b/i/birthday_popcorn_box_240x201.png'},
...
/** */
const goToSearchContainer = () => {
  router.push({
    path: '/homepage/search-container',
    query: {
      containerNo: containerSearchForm.value.containerNo
    }
  });
}
/** */
...
/** */
const goToSearchVesselSchedule = () => {
  router.push({path: '/homepage/search-vessel-schedule', query: {
    fromDate: vesselScheduleSearchForm.value.fromDate,
    toDate: vesselScheduleSearchForm.value.toDate
  }});
}
/** */
const goToPresentShippingline = () => {
  router.push('/homepage/present-shippingline');
}
/** */
const goToPresentLogistics = () => {
  router.push('/homepage/present-logistics');
}
/** */
const goToPresentDriver = () => {
  router.push('/homepage/present-driver');
}
/** */
const goToGuide = () => {
  router.push('/homepage/guide');
}
/** */
const goToDocument = () => {
  router.push('/homepage/document');
}
/** */
...
.login-body {
  ...
  max-height: calc(100vh - 61px - $base-header-height);
