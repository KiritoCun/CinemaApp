...
const columns = ref<GridColumn[]>([
  ...
  { prop: "fromDate", name: 'promotionManagement.columns.fromDateLb', sortable: true, size: 350, show: true, readonly: true },
  { prop: "toDate", name: 'promotionManagement.columns.toDateLb', sortable: true, size: 350, show: true, readonly: true },
