...
const columns = ref<GridColumn[]>([
  ...
  { prop: "releaseDate", name: 'movieManagement.columns.releaseDateLb', sortable: true, size: 350, show: true, readonly: true },
  { prop: "endDate", name: 'movieManagement.columns.endDateLb', sortable: true, size: 350, show: true, readonly: true },
