    ...
    <template v-slot:content>
      <b-container justify-content="space-between" fluid class="h-100 d-flex flex-row" :style="{ backgroundColor: '#F9F9F9', padding: '10%' }">
        <b-card style="flex: 1; max-width: 30%; margin-right: 10%; margin-bottom: 35px; height: 100%; display: flex">
          ...
          <h3 class="text-center mt-4 mb-7">{{userInfoData[0]?.userName}}</h3>
          <div class="table">
            <tbody>
              <tr>
                <td>
                  ...
                  <span class="d-inline">{{ userInfoData[0]?.nickName }}</span>
                </td>
              </tr>
              <tr>
                <td>
                  ...
                  <span class="d-inline">{{ userInfoData[0]?.email }}</span>
                </td>
              </tr>
              <tr>
                <td>
                  ...
                  <span class="d-inline">{{userInfoData[0]?.phonenumber}}</span>
                </td>
              </tr>
            </tbody>
          </div>
