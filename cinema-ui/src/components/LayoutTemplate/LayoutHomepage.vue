    ...
    <div :class="{ hasTagsView: true, sidebarHide: true }" class="main-container">
      <div :class="{ 'fixed-header': true }">
        <el-menu :default-active="activeIndex" class="nav-header" mode="horizontal" @select="handleNavigate">
          <el-menu-item index="login">{{ $t('homepage.topNav.login') }}</el-menu-item>
          <el-menu-item index="search">{{ $t('homepage.topNav.search') }}</el-menu-item>
          <el-menu-item index="present">{{ $t('homepage.topNav.present') }}</el-menu-item>
          <el-menu-item index="guideline">{{ $t('homepage.topNav.guideline') }}</el-menu-item>
          <el-menu-item index="document">{{ $t('homepage.topNav.document') }}</el-menu-item>
      ...
      <div class="login-body" id="loginBody">
        <div class="breadcrumb">
          ...
          <a class="home-link" href="/login">Trang chủ</a>
        ...
        <div class="contact-container" id="contact">
          <div class="contact-address">
            <img class="contact-logo" src="@/assets/logo/white-logo.png" />
            <div class="contact-address-detail">
              <div class="main-info">
                <div class="title-text">Địa chỉ liên hệ</div>
                <div class="sub-title-text">VIETNAM INTERNATIONAL CONTAINER TERMINALS</div>
              </div>
              <div class="sub-info">
                <div class="sub-info-item">
                  ...
                  <div class="content">
                    ...
                    <div class="normal-text">Số 13 Đường Bến Nghé, phường Tân Thuận Đông, <br />quận 7, TP. Hồ Chí Minh, Việt Nam</div>
                  </div>
                </div>
                <div class="sub-info-item">
                  <svg-icon icon-class="phone" />
                  <div class="content">
                    <div class="label-text">Điện thoại</div>
                    <div class="normal-text">(84-28) 3872 9999</div>
                  </div>
                </div>
                <div class="sub-info-item">
          ...
          <div class="contact-others">
            <div class="policy">
              <div class="title-text">Chính sách khách hàng</div>
              <div class="term">
                <div class="term-column1">
                  <div class="term-item">
                    <div class="icon-background"><svg-icon icon-class="play" /></div>
                    <div class="normal-text">Điều khoản dịch vụ</div>
                  </div>
                  <div class="term-item">
                    <div class="icon-background"><svg-icon icon-class="play" /></div>
                    <div class="normal-text">Chính sách đổi trả</div>
                  </div>
                  <div class="term-item">
                    <div class="icon-background"><svg-icon icon-class="play" /></div>
                    <div class="normal-text">chính sách khách hàng</div>
                  </div>
                </div>
                <div class="term-column2">
                  <div class="term-item">
                    <div class="icon-background"><svg-icon icon-class="play" /></div>
                    <div class="normal-text">Chính sách bảo mật</div>
                  </div>
                  <div class="term-item">
                    <div class="icon-background"><svg-icon icon-class="play" /></div>
                    <div class="normal-text">Điều khoản thanh toán</div>
                  </div>
                </div>
              </div>
            </div>
            <div class="support">
              <div class="title-text">Hỗ trợ</div>
              <div class="normal-text">
                Đăng ký sử dụng Cảng điện tử - VICT, trợ giúp hướng dẫn sử dụng, giải đáp thắc mắc vui lòng liên hệ Phòng thương vụ
              </div>
              <div class="support-info">
                <div class="support-info-item">
                  <div class="normal-text">Email</div>
                  <div class="email-text">info@vict-vn.com</div>
                </div>
                <div class="support-info-item">
                  ...
                  <div class="hotline">
                    ...
                    <div class="hotline-text">(84-28) 3872 4235</div>
                  </div>
                </div>
              </div>
            </div>
