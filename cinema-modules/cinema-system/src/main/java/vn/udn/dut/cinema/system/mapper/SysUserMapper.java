...
public interface SysUserMapper extends BaseMapperPlus<SysUser, SysUserVo> {
    ...
    Page<ShippinglineUserVo> selectPageShippinglineUserList(@Param("page") Page<SysUser> page, @Param(Constants.WRAPPER) Wrapper<SysUser> queryWrapper);
     ...
     * @return User object information
     */
    SysUserVo selectUserLogisticsByUserName(String userName);
}
