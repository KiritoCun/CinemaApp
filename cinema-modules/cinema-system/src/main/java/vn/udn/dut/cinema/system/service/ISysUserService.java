...
public interface ISysUserService {
    ...
    TableDataInfo<ShippinglineUserVo> selectPageUserList(ShippinglineUserBo user, PageQuery pageQuery);
    ...
    ShippinglineUserVo selectShippinglineUserById(Long userId);
    ...
    boolean checkUserNameUnique(ShippinglineUserBo user);
    ...
    boolean checkPhoneUnique(ShippinglineUserBo user);
    ...
    boolean checkEmailUnique(ShippinglineUserBo user);
    ...
    int insertUser(ShippinglineUserBo user);
    ...
    int updateUser(ShippinglineUserBo user);
